...
bool robotnik_battery_msgs__msg__battery_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robotnik_battery_msgs.msg._battery_status.BatteryStatus", full_classname_dest, 55) == 0);
  }
  robotnik_battery_msgs__msg__BatteryStatus * ros_message = _ros_message;
  {  // voltage
  ...
  {  // level
    ...
    assert(PyFloat_Check(field));
    ros_message->level = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // time_remaining
    ...
    ros_message->time_remaining = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // time_charging
    PyObject * field = PyObject_GetAttrString(_pymsg, "time_charging");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->time_charging = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // is_charging
...
PyObject * robotnik_battery_msgs__msg__battery_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robotnik_battery_msgs.msg._battery_status");
  ...
  {  // level
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->level);
    {
  ...
  {  // time_remaining
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->time_remaining);
    {
  ...
  {  // time_charging
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->time_charging);
    {
      int rc = PyObject_SetAttrString(_pymessage, "time_charging", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
