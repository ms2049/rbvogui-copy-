...
static const _DockingStationStatus_type_support_symbol_names_t _DockingStationStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robotnik_battery_msgs, msg, DockingStationStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robotnik_battery_msgs, msg, DockingStationStatus)),
  }
};
...
{
  return &::robotnik_battery_msgs::msg::rosidl_typesupport_cpp::DockingStationStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robotnik_battery_msgs, msg, DockingStationStatus)() {
  return get_message_type_support_handle<robotnik_battery_msgs::msg::DockingStationStatus>();
}
