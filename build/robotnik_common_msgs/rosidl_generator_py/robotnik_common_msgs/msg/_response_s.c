...
bool robotnik_common_msgs__msg__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robotnik_common_msgs.msg._response.Response", full_classname_dest, 43) == 0);
  }
  robotnik_common_msgs__msg__Response * ros_message = _ros_message;
  {  // success
...
PyObject * robotnik_common_msgs__msg__response__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robotnik_common_msgs.msg._response");
