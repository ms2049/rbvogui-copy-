...
static const _SetFloat32_Request_type_support_symbol_names_t _SetFloat32_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robotnik_common_msgs, srv, SetFloat32_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robotnik_common_msgs, srv, SetFloat32_Request)),
  }
};
...
{
  return &::robotnik_common_msgs::srv::rosidl_typesupport_cpp::SetFloat32_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robotnik_common_msgs, srv, SetFloat32_Request)() {
  return get_message_type_support_handle<robotnik_common_msgs::srv::SetFloat32_Request>();
}
...
static const _SetFloat32_Response_type_support_symbol_names_t _SetFloat32_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robotnik_common_msgs, srv, SetFloat32_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robotnik_common_msgs, srv, SetFloat32_Response)),
  }
};
...
{
  return &::robotnik_common_msgs::srv::rosidl_typesupport_cpp::SetFloat32_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robotnik_common_msgs, srv, SetFloat32_Response)() {
  return get_message_type_support_handle<robotnik_common_msgs::srv::SetFloat32_Response>();
}
...
static const _SetFloat32_type_support_symbol_names_t _SetFloat32_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robotnik_common_msgs, srv, SetFloat32)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robotnik_common_msgs, srv, SetFloat32)),
  }
};
...
{
  return &::robotnik_common_msgs::srv::rosidl_typesupport_cpp::SetFloat32_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, robotnik_common_msgs, srv, SetFloat32)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<robotnik_common_msgs::srv::SetFloat32>();
}
