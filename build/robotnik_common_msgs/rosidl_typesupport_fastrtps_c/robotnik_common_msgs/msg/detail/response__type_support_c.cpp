...
#include "robotnik_common_msgs/msg/detail/response__rosidl_typesupport_fastrtps_c.h"
...
using _Response__ros_msg_type = robotnik_common_msgs__msg__Response;
...
static uint32_t _Response__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robotnik_common_msgs__msg__Response(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robotnik_common_msgs__msg__Response;
    is_plain =
      (
...
static size_t _Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotnik_common_msgs__msg__Response(
