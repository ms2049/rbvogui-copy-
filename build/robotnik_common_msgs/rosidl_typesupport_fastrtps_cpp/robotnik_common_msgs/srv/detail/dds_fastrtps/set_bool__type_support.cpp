...
#include "robotnik_common_msgs/srv/detail/set_bool__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robotnik_common_msgs::srv::SetBool_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robotnik_common_msgs::srv::SetBool_Request & ros_message)
{
  // Member: data
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robotnik_common_msgs::srv::SetBool_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robotnik_common_msgs::srv::SetBool_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robotnik_common_msgs::srv::SetBool_Request *>(
    untyped_ros_message);
...
static size_t _SetBool_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetBool_Request(full_bounded, is_plain, 0);
...
{
  return &robotnik_common_msgs::srv::typesupport_fastrtps_cpp::_SetBool_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robotnik_common_msgs, srv, SetBool_Request)() {
  return &robotnik_common_msgs::srv::typesupport_fastrtps_cpp::_SetBool_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_robotnik_common_msgs
cdr_serialize(
  const robotnik_common_msgs::srv::SetBool_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: response
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robotnik_common_msgs::srv::SetBool_Response & ros_message)
{
  // Member: response
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robotnik_common_msgs::srv::SetBool_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robotnik_common_msgs::srv::SetBool_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robotnik_common_msgs::srv::SetBool_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _SetBool_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetBool_Response(full_bounded, is_plain, 0);
...
{
  return &robotnik_common_msgs::srv::typesupport_fastrtps_cpp::_SetBool_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robotnik_common_msgs, srv, SetBool_Response)() {
  return &robotnik_common_msgs::srv::typesupport_fastrtps_cpp::_SetBool_Response__handle;
}
...
{
  return &robotnik_common_msgs::srv::typesupport_fastrtps_cpp::_SetBool__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robotnik_common_msgs, srv, SetBool)() {
  return &robotnik_common_msgs::srv::typesupport_fastrtps_cpp::_SetBool__handle;
}
