...
#include "robotnik_common_msgs/srv/detail/set_string__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robotnik_common_msgs::srv::SetString_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robotnik_common_msgs::srv::SetString_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robotnik_common_msgs::srv::SetString_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetString_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const robotnik_common_msgs::srv::SetString_Request *>(
...
static size_t _SetString_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetString_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetString_Request__callbacks = {
...
static rosidl_message_type_support_t _SetString_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetString_Request__callbacks,
...
{
  return &robotnik_common_msgs::srv::typesupport_fastrtps_cpp::_SetString_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robotnik_common_msgs::srv::SetString_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robotnik_common_msgs::srv::SetString_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robotnik_common_msgs::srv::SetString_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetString_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const robotnik_common_msgs::srv::SetString_Response *>(
...
static size_t _SetString_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetString_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetString_Response__callbacks = {
  "robotnik_common_msgs::srv",
  "SetString_Response",
...
static rosidl_message_type_support_t _SetString_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetString_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &robotnik_common_msgs::srv::typesupport_fastrtps_cpp::_SetString_Response__handle;
}
...
static service_type_support_callbacks_t _SetString__callbacks = {
  "robotnik_common_msgs::srv",
  "SetString",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robotnik_common_msgs, srv, SetString_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robotnik_common_msgs, srv, SetString_Response)(),
...
static rosidl_service_type_support_t _SetString__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetString__callbacks,
...
{
  return &robotnik_common_msgs::srv::typesupport_fastrtps_cpp::_SetString__handle;
}
