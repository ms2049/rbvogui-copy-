    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'robotnik_controllers_msgs.msg.ControllerState')
            logger.debug(
...
class ControllerState(metaclass=Metaclass_ControllerState):
    ...
    def __init__(self, **kwargs):
        ...
        self.state_number = kwargs.get('state_number', int())
    ...
    def state_number(self):
        """Message field 'state_number'."""
        return self._state_number

    @state_number.setter
    def state_number(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'state_number' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'state_number' field must be an unsigned integer in [0, 255]"
        self._state_number = value
