...
static const _ControllerState_type_support_symbol_names_t _ControllerState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_controllers_msgs, msg, ControllerState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotnik_controllers_msgs, msg, ControllerState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotnik_controllers_msgs, msg, ControllerState)() {
  return &::robotnik_controllers_msgs::msg::rosidl_typesupport_c::ControllerState_message_type_support_handle;
}
