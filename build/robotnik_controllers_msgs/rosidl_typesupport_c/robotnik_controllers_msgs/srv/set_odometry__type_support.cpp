...
static const _SetOdometry_Request_type_support_symbol_names_t _SetOdometry_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_controllers_msgs, srv, SetOdometry_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotnik_controllers_msgs, srv, SetOdometry_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotnik_controllers_msgs, srv, SetOdometry_Request)() {
  return &::robotnik_controllers_msgs::srv::rosidl_typesupport_c::SetOdometry_Request_message_type_support_handle;
}
...
static const _SetOdometry_Response_type_support_symbol_names_t _SetOdometry_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_controllers_msgs, srv, SetOdometry_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotnik_controllers_msgs, srv, SetOdometry_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotnik_controllers_msgs, srv, SetOdometry_Response)() {
  return &::robotnik_controllers_msgs::srv::rosidl_typesupport_c::SetOdometry_Response_message_type_support_handle;
}
...
static const _SetOdometry_type_support_symbol_names_t _SetOdometry_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_controllers_msgs, srv, SetOdometry)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotnik_controllers_msgs, srv, SetOdometry)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, robotnik_controllers_msgs, srv, SetOdometry)() {
  return &::robotnik_controllers_msgs::srv::rosidl_typesupport_c::SetOdometry_service_type_support_handle;
}
