...
#include "robotnik_controllers_msgs/msg/detail/controller_state__rosidl_typesupport_fastrtps_c.h"
...
using _ControllerState__ros_msg_type = robotnik_controllers_msgs__msg__ControllerState;
...
static uint32_t _ControllerState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robotnik_controllers_msgs__msg__ControllerState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robotnik_controllers_msgs__msg__ControllerState;
    is_plain =
      (
...
static size_t _ControllerState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotnik_controllers_msgs__msg__ControllerState(
