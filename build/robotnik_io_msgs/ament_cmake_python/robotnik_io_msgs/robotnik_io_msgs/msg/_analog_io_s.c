...
bool robotnik_io_msgs__msg__analog_io__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robotnik_io_msgs.msg._analog_io.AnalogIO", full_classname_dest, 40) == 0);
  }
  robotnik_io_msgs__msg__AnalogIO * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of AnalogIO */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robotnik_io_msgs.msg._analog_io");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AnalogIO");
