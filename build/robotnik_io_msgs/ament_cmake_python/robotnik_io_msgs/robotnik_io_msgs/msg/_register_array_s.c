...
bool robotnik_io_msgs__msg__register_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robotnik_io_msgs.msg._register_array.RegisterArray", full_classname_dest, 50) == 0);
  }
  robotnik_io_msgs__msg__RegisterArray * ros_message = _ros_message;
  {  // registers
...
{
  /* NOTE(esteve): Call constructor of RegisterArray */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robotnik_io_msgs.msg._register_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RegisterArray");
