...
bool robotnik_io_msgs__msg__register__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robotnik_io_msgs.msg._register.Register", full_classname_dest, 39) == 0);
  }
  robotnik_io_msgs__msg__Register * ros_message = _ros_message;
  {  // address
...
{
  /* NOTE(esteve): Call constructor of Register */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robotnik_io_msgs.msg._register");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Register");
