...
class SetAnalogOutput_Request(metaclass=Metaclass_SetAnalogOutput_Request):
    ...
    _fields_and_field_types = {
        'output': 'robotnik_io_msgs/AnalogIO',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['robotnik_io_msgs', 'msg'], 'AnalogIO'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robotnik_io_msgs.msg import AnalogIO
        self.output = kwargs.get('output', AnalogIO())
    ...
    def output(self, value):
        if __debug__:
            from robotnik_io_msgs.msg import AnalogIO
            assert \
                isinstance(value, AnalogIO), \
                "The 'output' field must be a sub message of type 'AnalogIO'"
        self._output = value
...
class Metaclass_SetAnalogOutput(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robotnik_io_msgs.srv.SetAnalogOutput')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from robotnik_io_msgs.srv import _set_analog_output
...
class SetAnalogOutput(metaclass=Metaclass_SetAnalogOutput):
    from robotnik_io_msgs.srv._set_analog_output import SetAnalogOutput_Request as Request
    from robotnik_io_msgs.srv._set_analog_output import SetAnalogOutput_Response as Response
