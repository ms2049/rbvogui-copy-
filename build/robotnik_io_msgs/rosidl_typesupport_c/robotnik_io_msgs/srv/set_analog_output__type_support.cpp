...
static const _SetAnalogOutput_Request_type_support_symbol_names_t _SetAnalogOutput_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_io_msgs, srv, SetAnalogOutput_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotnik_io_msgs, srv, SetAnalogOutput_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotnik_io_msgs, srv, SetAnalogOutput_Request)() {
  return &::robotnik_io_msgs::srv::rosidl_typesupport_c::SetAnalogOutput_Request_message_type_support_handle;
}
...
static const _SetAnalogOutput_Response_type_support_symbol_names_t _SetAnalogOutput_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_io_msgs, srv, SetAnalogOutput_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotnik_io_msgs, srv, SetAnalogOutput_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotnik_io_msgs, srv, SetAnalogOutput_Response)() {
  return &::robotnik_io_msgs::srv::rosidl_typesupport_c::SetAnalogOutput_Response_message_type_support_handle;
}
...
static const _SetAnalogOutput_type_support_symbol_names_t _SetAnalogOutput_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_io_msgs, srv, SetAnalogOutput)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotnik_io_msgs, srv, SetAnalogOutput)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, robotnik_io_msgs, srv, SetAnalogOutput)() {
  return &::robotnik_io_msgs::srv::rosidl_typesupport_c::SetAnalogOutput_service_type_support_handle;
}
