...
static const _InputsOutputs_type_support_symbol_names_t _InputsOutputs_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robotnik_io_msgs, msg, InputsOutputs)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robotnik_io_msgs, msg, InputsOutputs)),
  }
};
...
{
  return &::robotnik_io_msgs::msg::rosidl_typesupport_cpp::InputsOutputs_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robotnik_io_msgs, msg, InputsOutputs)() {
  return get_message_type_support_handle<robotnik_io_msgs::msg::InputsOutputs>();
}
