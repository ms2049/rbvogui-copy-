...
#include "robotnik_io_msgs/msg/detail/register_array__rosidl_typesupport_fastrtps_c.h"
...
using _RegisterArray__ros_msg_type = robotnik_io_msgs__msg__RegisterArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RegisterArray__ros_msg_type * ros_message = static_cast<const _RegisterArray__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _RegisterArray__ros_msg_type * ros_message = static_cast<_RegisterArray__ros_msg_type *>(untyped_ros_message);
  // Field name: registers
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_robotnik_io_msgs__msg__RegisterArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RegisterArray__ros_msg_type * ros_message = static_cast<const _RegisterArray__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RegisterArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robotnik_io_msgs__msg__RegisterArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_io_msgs
size_t max_serialized_size_robotnik_io_msgs__msg__RegisterArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robotnik_io_msgs__msg__RegisterArray;
    is_plain =
      (
...
static size_t _RegisterArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotnik_io_msgs__msg__RegisterArray(
...
static message_type_support_callbacks_t __callbacks_RegisterArray = {
...
static rosidl_message_type_support_t _RegisterArray__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RegisterArray,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_io_msgs, msg, RegisterArray)() {
  return &_RegisterArray__type_support;
}
