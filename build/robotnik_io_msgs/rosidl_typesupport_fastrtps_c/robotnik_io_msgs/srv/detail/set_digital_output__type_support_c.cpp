...
#include "robotnik_io_msgs/srv/detail/set_digital_output__rosidl_typesupport_fastrtps_c.h"
...
using _SetDigitalOutput_Request__ros_msg_type = robotnik_io_msgs__srv__SetDigitalOutput_Request;
...
size_t get_serialized_size_robotnik_io_msgs__srv__SetDigitalOutput_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetDigitalOutput_Request__ros_msg_type * ros_message = static_cast<const _SetDigitalOutput_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetDigitalOutput_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robotnik_io_msgs__srv__SetDigitalOutput_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_io_msgs
size_t max_serialized_size_robotnik_io_msgs__srv__SetDigitalOutput_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robotnik_io_msgs__srv__SetDigitalOutput_Request;
    is_plain =
      (
...
static size_t _SetDigitalOutput_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotnik_io_msgs__srv__SetDigitalOutput_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_io_msgs, srv, SetDigitalOutput_Request)() {
...
using _SetDigitalOutput_Response__ros_msg_type = robotnik_io_msgs__srv__SetDigitalOutput_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_io_msgs
size_t get_serialized_size_robotnik_io_msgs__srv__SetDigitalOutput_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetDigitalOutput_Response__ros_msg_type * ros_message = static_cast<const _SetDigitalOutput_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robotnik_io_msgs__srv__SetDigitalOutput_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_io_msgs
size_t max_serialized_size_robotnik_io_msgs__srv__SetDigitalOutput_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robotnik_io_msgs__srv__SetDigitalOutput_Response;
    is_plain =
      (
...
static size_t _SetDigitalOutput_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotnik_io_msgs__srv__SetDigitalOutput_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_io_msgs, srv, SetDigitalOutput_Response)() {
...
// already included above
// #include "robotnik_io_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "robotnik_io_msgs/srv/set_digital_output.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_io_msgs, srv, SetDigitalOutput)() {
