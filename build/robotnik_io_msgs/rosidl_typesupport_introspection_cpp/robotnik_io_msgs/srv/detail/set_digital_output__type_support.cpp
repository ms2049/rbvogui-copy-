...
{
  new (message_memory) robotnik_io_msgs::srv::SetDigitalOutput_Request(_init);
}

void SetDigitalOutput_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robotnik_io_msgs::srv::SetDigitalOutput_Request *>(message_memory);
  typed_message->~SetDigitalOutput_Request();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember SetDigitalOutput_Request_message_member_array[1] = {
  {
    "output",  // name
    ...
    offsetof(robotnik_io_msgs::srv::SetDigitalOutput_Request, output),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetDigitalOutput_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(robotnik_io_msgs::srv::SetDigitalOutput_Request),
...
{
  return &::robotnik_io_msgs::srv::rosidl_typesupport_introspection_cpp::SetDigitalOutput_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robotnik_io_msgs, srv, SetDigitalOutput_Request)() {
  return &::robotnik_io_msgs::srv::rosidl_typesupport_introspection_cpp::SetDigitalOutput_Request_message_type_support_handle;
}
...
void SetDigitalOutput_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) robotnik_io_msgs::srv::SetDigitalOutput_Response(_init);
}

void SetDigitalOutput_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robotnik_io_msgs::srv::SetDigitalOutput_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetDigitalOutput_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robotnik_io_msgs::srv::SetDigitalOutput_Response, response),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetDigitalOutput_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(robotnik_io_msgs::srv::SetDigitalOutput_Response),
...
{
  return &::robotnik_io_msgs::srv::rosidl_typesupport_introspection_cpp::SetDigitalOutput_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robotnik_io_msgs, srv, SetDigitalOutput_Response)() {
  return &::robotnik_io_msgs::srv::rosidl_typesupport_introspection_cpp::SetDigitalOutput_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SetDigitalOutput_service_members = {
  ...
  // see get_service_type_support_handle<robotnik_io_msgs::srv::SetDigitalOutput>()
...
get_service_type_support_handle<robotnik_io_msgs::srv::SetDigitalOutput>()
{
  ...
  auto service_type_support =
    &::robotnik_io_msgs::srv::rosidl_typesupport_introspection_cpp::SetDigitalOutput_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robotnik_io_msgs, srv, SetDigitalOutput)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<robotnik_io_msgs::srv::SetDigitalOutput>();
}
