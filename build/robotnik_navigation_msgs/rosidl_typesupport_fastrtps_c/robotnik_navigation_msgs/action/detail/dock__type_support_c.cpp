...
#include "robotnik_navigation_msgs/action/detail/dock__rosidl_typesupport_fastrtps_c.h"
...
#include "robotnik_navigation_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
#include "geometry_msgs/msg/detail/pose2_d__functions.h"  // dock_offset
#include "geometry_msgs/msg/detail/twist__functions.h"  // maximum_velocity
#include "rosidl_runtime_c/string.h"  // dock_frame, robot_dock_frame
#include "rosidl_runtime_c/string_functions.h"  // dock_frame, robot_dock_frame

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_robotnik_navigation_msgs
...
using _Dock_Goal__ros_msg_type = robotnik_navigation_msgs__action__Dock_Goal;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: dock_frame
  {
    const rosidl_runtime_c__String * str = &ros_message->dock_frame;
  ...
  // Field name: robot_dock_frame
  {
    const rosidl_runtime_c__String * str = &ros_message->robot_dock_frame;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  // Field name: dock_offset
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->dock_offset, cdr))
    {
      return false;
    }
  }

  // Field name: maximum_velocity
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->maximum_velocity, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: dock_frame
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->dock_frame.data) {
      rosidl_runtime_c__String__init(&ros_message->dock_frame);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->dock_frame,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'dock_frame'\n");
      return false;
    }
  }
  ...
  // Field name: robot_dock_frame
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->robot_dock_frame.data) {
      rosidl_runtime_c__String__init(&ros_message->robot_dock_frame);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->robot_dock_frame,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'robot_dock_frame'\n");
      return false;
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_navigation_msgs
size_t get_serialized_size_robotnik_navigation_msgs__action__Dock_Goal(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Dock_Goal__ros_msg_type * ros_message = static_cast<const _Dock_Goal__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += padding +
    ...
    (ros_message->dock_frame.size + 1);
  // field.name robot_dock_frame
  current_alignment += padding +
    eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
    (ros_message->robot_dock_frame.size + 1);
  // field.name dock_offset

  current_alignment += get_serialized_size_geometry_msgs__msg__Pose2D(
    &(ros_message->dock_offset), current_alignment);
  // field.name maximum_velocity
...
static uint32_t _Dock_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robotnik_navigation_msgs__action__Dock_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_navigation_msgs
size_t max_serialized_size_robotnik_navigation_msgs__action__Dock_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robotnik_navigation_msgs__action__Dock_Goal;
    is_plain =
      (
...
static size_t _Dock_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotnik_navigation_msgs__action__Dock_Goal(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_navigation_msgs, action, Dock_Goal)() {
...
using _Dock_Result__ros_msg_type = robotnik_navigation_msgs__action__Dock_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_navigation_msgs
size_t get_serialized_size_robotnik_navigation_msgs__action__Dock_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Dock_Result__ros_msg_type * ros_message = static_cast<const _Dock_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robotnik_navigation_msgs__action__Dock_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_navigation_msgs
size_t max_serialized_size_robotnik_navigation_msgs__action__Dock_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robotnik_navigation_msgs__action__Dock_Result;
    is_plain =
      (
...
static size_t _Dock_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotnik_navigation_msgs__action__Dock_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_navigation_msgs, action, Dock_Result)() {
...
// already included above
// #include "geometry_msgs/msg/detail/pose2_d__functions.h"  // remaining
// already included above
...
using _Dock_Feedback__ros_msg_type = robotnik_navigation_msgs__action__Dock_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_navigation_msgs
size_t get_serialized_size_robotnik_navigation_msgs__action__Dock_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Dock_Feedback__ros_msg_type * ros_message = static_cast<const _Dock_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robotnik_navigation_msgs__action__Dock_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_navigation_msgs
size_t max_serialized_size_robotnik_navigation_msgs__action__Dock_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robotnik_navigation_msgs__action__Dock_Feedback;
    is_plain =
      (
...
static size_t _Dock_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotnik_navigation_msgs__action__Dock_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_navigation_msgs, action, Dock_Feedback)() {
...
// already included above
// #include "robotnik_navigation_msgs/action/detail/dock__functions.h"  // goal
...
using _Dock_SendGoal_Request__ros_msg_type = robotnik_navigation_msgs__action__Dock_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, robotnik_navigation_msgs, action, Dock_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_navigation_msgs
size_t get_serialized_size_robotnik_navigation_msgs__action__Dock_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Dock_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _Dock_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_robotnik_navigation_msgs__action__Dock_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robotnik_navigation_msgs__action__Dock_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_navigation_msgs
size_t max_serialized_size_robotnik_navigation_msgs__action__Dock_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_robotnik_navigation_msgs__action__Dock_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robotnik_navigation_msgs__action__Dock_SendGoal_Request;
    is_plain =
      (
...
static size_t _Dock_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotnik_navigation_msgs__action__Dock_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_navigation_msgs, action, Dock_SendGoal_Request)() {
...
using _Dock_SendGoal_Response__ros_msg_type = robotnik_navigation_msgs__action__Dock_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_navigation_msgs
size_t get_serialized_size_robotnik_navigation_msgs__action__Dock_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Dock_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _Dock_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robotnik_navigation_msgs__action__Dock_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_navigation_msgs
size_t max_serialized_size_robotnik_navigation_msgs__action__Dock_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robotnik_navigation_msgs__action__Dock_SendGoal_Response;
    is_plain =
      (
...
static size_t _Dock_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotnik_navigation_msgs__action__Dock_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_navigation_msgs, action, Dock_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_navigation_msgs, action, Dock_SendGoal)() {
...
using _Dock_GetResult_Request__ros_msg_type = robotnik_navigation_msgs__action__Dock_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_navigation_msgs
size_t get_serialized_size_robotnik_navigation_msgs__action__Dock_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Dock_GetResult_Request__ros_msg_type * ros_message = static_cast<const _Dock_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robotnik_navigation_msgs__action__Dock_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_navigation_msgs
size_t max_serialized_size_robotnik_navigation_msgs__action__Dock_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robotnik_navigation_msgs__action__Dock_GetResult_Request;
    is_plain =
      (
...
static size_t _Dock_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotnik_navigation_msgs__action__Dock_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_navigation_msgs, action, Dock_GetResult_Request)() {
...
// already included above
// #include "robotnik_navigation_msgs/action/detail/dock__functions.h"  // result
...
using _Dock_GetResult_Response__ros_msg_type = robotnik_navigation_msgs__action__Dock_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, robotnik_navigation_msgs, action, Dock_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_navigation_msgs
size_t get_serialized_size_robotnik_navigation_msgs__action__Dock_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Dock_GetResult_Response__ros_msg_type * ros_message = static_cast<const _Dock_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_robotnik_navigation_msgs__action__Dock_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robotnik_navigation_msgs__action__Dock_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_navigation_msgs
size_t max_serialized_size_robotnik_navigation_msgs__action__Dock_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_robotnik_navigation_msgs__action__Dock_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robotnik_navigation_msgs__action__Dock_GetResult_Response;
    is_plain =
      (
...
static size_t _Dock_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotnik_navigation_msgs__action__Dock_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_navigation_msgs, action, Dock_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_navigation_msgs, action, Dock_GetResult)() {
...
// already included above
// #include "robotnik_navigation_msgs/action/detail/dock__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _Dock_FeedbackMessage__ros_msg_type = robotnik_navigation_msgs__action__Dock_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, robotnik_navigation_msgs, action, Dock_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_navigation_msgs
size_t get_serialized_size_robotnik_navigation_msgs__action__Dock_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Dock_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _Dock_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_robotnik_navigation_msgs__action__Dock_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robotnik_navigation_msgs__action__Dock_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_navigation_msgs
size_t max_serialized_size_robotnik_navigation_msgs__action__Dock_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_robotnik_navigation_msgs__action__Dock_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robotnik_navigation_msgs__action__Dock_FeedbackMessage;
    is_plain =
      (
...
static size_t _Dock_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotnik_navigation_msgs__action__Dock_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_navigation_msgs, action, Dock_FeedbackMessage)() {
