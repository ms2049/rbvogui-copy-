...
class Metaclass_Detection(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('robotnik_perception_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'robotnik_perception_msgs.msg.Detection')
            logger.debug(
...
class Detection(metaclass=Metaclass_Detection):
    ...
    _fields_and_field_types = {
        ...
        'object': 'geometry_msgs/PoseStamped',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import PoseStamped
        self.object = kwargs.get('object', PoseStamped())
    ...
    def object(self, value):  # noqa: A003
        if __debug__:
            ...
            assert \
                ...
                "The 'object' field must be a sub message of type 'PoseStamped'"
        self._object = value
