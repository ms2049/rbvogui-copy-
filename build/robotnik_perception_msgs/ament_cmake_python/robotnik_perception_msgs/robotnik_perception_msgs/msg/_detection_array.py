    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'robotnik_perception_msgs.msg.DetectionArray')
            logger.debug(
...
class DetectionArray(metaclass=Metaclass_DetectionArray):
    ...
    _fields_and_field_types = {
        ...
        'objects': 'sequence<geometry_msgs/PoseStamped>',
    }
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'objects' field must be a set or sequence and each value of type 'PoseStamped'"
        self._objects = value
