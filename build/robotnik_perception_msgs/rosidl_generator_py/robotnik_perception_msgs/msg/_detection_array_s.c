...
bool robotnik_perception_msgs__msg__detection_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robotnik_perception_msgs.msg._detection_array.DetectionArray", full_classname_dest, 60) == 0);
  }
  robotnik_perception_msgs__msg__DetectionArray * ros_message = _ros_message;
  {  // header
  ...
  {  // objects
    ...
    geometry_msgs__msg__PoseStamped * dest = ros_message->objects.data;
...
PyObject * robotnik_perception_msgs__msg__detection_array__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robotnik_perception_msgs.msg._detection_array");
