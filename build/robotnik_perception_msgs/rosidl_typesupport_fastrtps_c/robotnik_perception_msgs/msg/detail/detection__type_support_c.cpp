...
#include "robotnik_perception_msgs/msg/detail/detection__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/pose_stamped__functions.h"  // object
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_robotnik_perception_msgs
...
using _Detection__ros_msg_type = robotnik_perception_msgs__msg__Detection;
...
size_t get_serialized_size_robotnik_perception_msgs__msg__Detection(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Detection__ros_msg_type * ros_message = static_cast<const _Detection__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Detection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robotnik_perception_msgs__msg__Detection(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotnik_perception_msgs
size_t max_serialized_size_robotnik_perception_msgs__msg__Detection(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robotnik_perception_msgs__msg__Detection;
    is_plain =
      (
...
static size_t _Detection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotnik_perception_msgs__msg__Detection(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotnik_perception_msgs, msg, Detection)() {
