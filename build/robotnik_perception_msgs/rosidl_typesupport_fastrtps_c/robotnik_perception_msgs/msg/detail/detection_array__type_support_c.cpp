...
#include "robotnik_perception_msgs/msg/detail/detection_array__rosidl_typesupport_fastrtps_c.h"
...
using _DetectionArray__ros_msg_type = robotnik_perception_msgs__msg__DetectionArray;
...
static uint32_t _DetectionArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robotnik_perception_msgs__msg__DetectionArray(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robotnik_perception_msgs__msg__DetectionArray;
    is_plain =
      (
...
static size_t _DetectionArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotnik_perception_msgs__msg__DetectionArray(
