...
#include "robotnik_perception_msgs/msg/detail/detection__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robotnik_perception_msgs::msg::Detection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robotnik_perception_msgs::msg::Detection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robotnik_perception_msgs::msg::Detection *>(
    untyped_ros_message);
...
{
  return &robotnik_perception_msgs::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
