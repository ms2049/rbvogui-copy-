...
#include "robotnik_perception_msgs/msg/detail/detection_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robotnik_perception_msgs::msg::DetectionArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robotnik_perception_msgs::msg::DetectionArray & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robotnik_perception_msgs::msg::DetectionArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robotnik_perception_msgs::msg::DetectionArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robotnik_perception_msgs::msg::DetectionArray *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_robotnik_perception_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<robotnik_perception_msgs::msg::DetectionArray>()
{
  return &robotnik_perception_msgs::msg::typesupport_fastrtps_cpp::_DetectionArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robotnik_perception_msgs, msg, DetectionArray)() {
  return &robotnik_perception_msgs::msg::typesupport_fastrtps_cpp::_DetectionArray__handle;
}
