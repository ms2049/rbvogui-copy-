...
#ifndef ROBOTNIK_SUPERVISOR_MSGS__SRV__DETAIL__GET_MODULE_LIST__FUNCTIONS_H_
#define ROBOTNIK_SUPERVISOR_MSGS__SRV__DETAIL__GET_MODULE_LIST__FUNCTIONS_H_
...
/// Initialize srv/GetModuleList message.
/**
...
/// Finalize srv/GetModuleList message.
/**
...
/// Create srv/GetModuleList message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robotnik_supervisor_msgs__srv__GetModuleList_Request__init().
...
/// Destroy srv/GetModuleList message.
/**
 * It calls
 * robotnik_supervisor_msgs__srv__GetModuleList_Request__fini()
...
/// Check for srv/GetModuleList message equality.
/**
...
/// Copy a srv/GetModuleList message.
/**
...
/// Initialize array of srv/GetModuleList messages.
/**
...
/// Finalize array of srv/GetModuleList messages.
/**
 * It calls
 * robotnik_supervisor_msgs__srv__GetModuleList_Request__fini()
...
/// Create array of srv/GetModuleList messages.
/**
 * It allocates the memory for the array and calls
 * robotnik_supervisor_msgs__srv__GetModuleList_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetModuleList messages.
/**
 * It calls
 * robotnik_supervisor_msgs__srv__GetModuleList_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetModuleList message array equality.
/**
...
/// Copy an array of srv/GetModuleList messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robotnik_supervisor_msgs__srv__GetModuleList_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robotnik_supervisor_msgs
...
/**
 * It calls
 * robotnik_supervisor_msgs__srv__GetModuleList_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robotnik_supervisor_msgs
...
/**
 * It allocates the memory for the array and calls
 * robotnik_supervisor_msgs__srv__GetModuleList_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robotnik_supervisor_msgs
...
/**
 * It calls
 * robotnik_supervisor_msgs__srv__GetModuleList_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOTNIK_SUPERVISOR_MSGS__SRV__DETAIL__GET_MODULE_LIST__FUNCTIONS_H_
