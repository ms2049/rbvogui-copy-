...
#ifndef ROBOTNIK_SUPERVISOR_MSGS__SRV__DETAIL__GET_STACK_LIST__FUNCTIONS_H_
#define ROBOTNIK_SUPERVISOR_MSGS__SRV__DETAIL__GET_STACK_LIST__FUNCTIONS_H_
...
/// Initialize srv/GetStackList message.
/**
...
/// Finalize srv/GetStackList message.
/**
...
/// Create srv/GetStackList message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robotnik_supervisor_msgs__srv__GetStackList_Request__init().
...
/// Destroy srv/GetStackList message.
/**
 * It calls
 * robotnik_supervisor_msgs__srv__GetStackList_Request__fini()
...
/// Check for srv/GetStackList message equality.
/**
...
/// Copy a srv/GetStackList message.
/**
...
/// Initialize array of srv/GetStackList messages.
/**
...
/// Finalize array of srv/GetStackList messages.
/**
 * It calls
 * robotnik_supervisor_msgs__srv__GetStackList_Request__fini()
...
/// Create array of srv/GetStackList messages.
/**
 * It allocates the memory for the array and calls
 * robotnik_supervisor_msgs__srv__GetStackList_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetStackList messages.
/**
 * It calls
 * robotnik_supervisor_msgs__srv__GetStackList_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetStackList message array equality.
/**
...
/// Copy an array of srv/GetStackList messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robotnik_supervisor_msgs__srv__GetStackList_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robotnik_supervisor_msgs
...
/**
 * It calls
 * robotnik_supervisor_msgs__srv__GetStackList_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robotnik_supervisor_msgs
...
/**
 * It allocates the memory for the array and calls
 * robotnik_supervisor_msgs__srv__GetStackList_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robotnik_supervisor_msgs
...
/**
 * It calls
 * robotnik_supervisor_msgs__srv__GetStackList_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOTNIK_SUPERVISOR_MSGS__SRV__DETAIL__GET_STACK_LIST__FUNCTIONS_H_
