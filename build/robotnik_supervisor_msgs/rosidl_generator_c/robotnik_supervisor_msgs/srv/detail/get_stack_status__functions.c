...
robotnik_supervisor_msgs__srv__GetStackStatus_Request__init(robotnik_supervisor_msgs__srv__GetStackStatus_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->name)) {
    robotnik_supervisor_msgs__srv__GetStackStatus_Request__fini(msg);
    return false;
  }
  return true;
}
...
robotnik_supervisor_msgs__srv__GetStackStatus_Request__create()
{
  ...
  robotnik_supervisor_msgs__srv__GetStackStatus_Request * msg = (robotnik_supervisor_msgs__srv__GetStackStatus_Request *)allocator.allocate(sizeof(robotnik_supervisor_msgs__srv__GetStackStatus_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robotnik_supervisor_msgs__srv__GetStackStatus_Request));
  bool success = robotnik_supervisor_msgs__srv__GetStackStatus_Request__init(msg);
  if (!success) {
...
robotnik_supervisor_msgs__srv__GetStackStatus_Request__Sequence__init(robotnik_supervisor_msgs__srv__GetStackStatus_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_supervisor_msgs__srv__GetStackStatus_Request * data = NULL;

  if (size) {
    data = (robotnik_supervisor_msgs__srv__GetStackStatus_Request *)allocator.zero_allocate(size, sizeof(robotnik_supervisor_msgs__srv__GetStackStatus_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robotnik_supervisor_msgs__srv__GetStackStatus_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        robotnik_supervisor_msgs__srv__GetStackStatus_Request__fini(&data[i - 1]);
      }
...
robotnik_supervisor_msgs__srv__GetStackStatus_Request__Sequence__fini(robotnik_supervisor_msgs__srv__GetStackStatus_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      robotnik_supervisor_msgs__srv__GetStackStatus_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_supervisor_msgs__srv__GetStackStatus_Request__Sequence * array = (robotnik_supervisor_msgs__srv__GetStackStatus_Request__Sequence *)allocator.allocate(sizeof(robotnik_supervisor_msgs__srv__GetStackStatus_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robotnik_supervisor_msgs__srv__GetStackStatus_Request__Sequence__init(array, size);
  if (!success) {
...
robotnik_supervisor_msgs__srv__GetStackStatus_Request__Sequence__destroy(robotnik_supervisor_msgs__srv__GetStackStatus_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robotnik_supervisor_msgs__srv__GetStackStatus_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robotnik_supervisor_msgs__srv__GetStackStatus_Request__Sequence__are_equal(const robotnik_supervisor_msgs__srv__GetStackStatus_Request__Sequence * lhs, const robotnik_supervisor_msgs__srv__GetStackStatus_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robotnik_supervisor_msgs__srv__GetStackStatus_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robotnik_supervisor_msgs__srv__GetStackStatus_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robotnik_supervisor_msgs__srv__GetStackStatus_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robotnik_supervisor_msgs__srv__GetStackStatus_Request * data =
      (robotnik_supervisor_msgs__srv__GetStackStatus_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robotnik_supervisor_msgs__srv__GetStackStatus_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robotnik_supervisor_msgs__srv__GetStackStatus_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!robotnik_supervisor_msgs__srv__GetStackStatus_Request__copy(
...
robotnik_supervisor_msgs__srv__GetStackStatus_Response__init(robotnik_supervisor_msgs__srv__GetStackStatus_Response * msg)
{
  ...
  if (!robotnik_common_msgs__msg__Response__init(&msg->response)) {
    robotnik_supervisor_msgs__srv__GetStackStatus_Response__fini(msg);
    return false;
  }
  // status
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_supervisor_msgs__srv__GetStackStatus_Response * msg = (robotnik_supervisor_msgs__srv__GetStackStatus_Response *)allocator.allocate(sizeof(robotnik_supervisor_msgs__srv__GetStackStatus_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robotnik_supervisor_msgs__srv__GetStackStatus_Response));
  bool success = robotnik_supervisor_msgs__srv__GetStackStatus_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
robotnik_supervisor_msgs__srv__GetStackStatus_Response__Sequence__init(robotnik_supervisor_msgs__srv__GetStackStatus_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_supervisor_msgs__srv__GetStackStatus_Response * data = NULL;

  if (size) {
    data = (robotnik_supervisor_msgs__srv__GetStackStatus_Response *)allocator.zero_allocate(size, sizeof(robotnik_supervisor_msgs__srv__GetStackStatus_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robotnik_supervisor_msgs__srv__GetStackStatus_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robotnik_supervisor_msgs__srv__GetStackStatus_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
robotnik_supervisor_msgs__srv__GetStackStatus_Response__Sequence__fini(robotnik_supervisor_msgs__srv__GetStackStatus_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robotnik_supervisor_msgs__srv__GetStackStatus_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_supervisor_msgs__srv__GetStackStatus_Response__Sequence * array = (robotnik_supervisor_msgs__srv__GetStackStatus_Response__Sequence *)allocator.allocate(sizeof(robotnik_supervisor_msgs__srv__GetStackStatus_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robotnik_supervisor_msgs__srv__GetStackStatus_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
robotnik_supervisor_msgs__srv__GetStackStatus_Response__Sequence__destroy(robotnik_supervisor_msgs__srv__GetStackStatus_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robotnik_supervisor_msgs__srv__GetStackStatus_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robotnik_supervisor_msgs__srv__GetStackStatus_Response__Sequence__are_equal(const robotnik_supervisor_msgs__srv__GetStackStatus_Response__Sequence * lhs, const robotnik_supervisor_msgs__srv__GetStackStatus_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robotnik_supervisor_msgs__srv__GetStackStatus_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robotnik_supervisor_msgs__srv__GetStackStatus_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robotnik_supervisor_msgs__srv__GetStackStatus_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robotnik_supervisor_msgs__srv__GetStackStatus_Response * data =
      (robotnik_supervisor_msgs__srv__GetStackStatus_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robotnik_supervisor_msgs__srv__GetStackStatus_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robotnik_supervisor_msgs__srv__GetStackStatus_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robotnik_supervisor_msgs__srv__GetStackStatus_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
