...
{
  new (message_memory) robotnik_common_msgs::msg::Response(_init);
}

void Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robotnik_common_msgs::msg::Response *>(message_memory);
  typed_message->~Response();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Response_message_member_array[2] = {
  {
    "success",  // name
    ...
    offsetof(robotnik_common_msgs::msg::Response, success),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robotnik_common_msgs::msg::Response, message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Response_message_members = {
  "robotnik_common_msgs::msg",  // message namespace
  "Response",  // message name
  2,  // number of fields
  sizeof(robotnik_common_msgs::msg::Response),
...
{
  return &::robotnik_common_msgs::msg::rosidl_typesupport_introspection_cpp::Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robotnik_common_msgs, msg, Response)() {
  return &::robotnik_common_msgs::msg::rosidl_typesupport_introspection_cpp::Response_message_type_support_handle;
}
