...
#ifndef ROBOTNIK_CONTROLLERS_MSGS__SRV__DETAIL__SET_ODOMETRY__FUNCTIONS_H_
#define ROBOTNIK_CONTROLLERS_MSGS__SRV__DETAIL__SET_ODOMETRY__FUNCTIONS_H_
...
/// Initialize srv/SetOdometry message.
/**
...
/// Finalize srv/SetOdometry message.
/**
...
/// Create srv/SetOdometry message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robotnik_controllers_msgs__srv__SetOdometry_Request__init().
...
/// Destroy srv/SetOdometry message.
/**
 * It calls
 * robotnik_controllers_msgs__srv__SetOdometry_Request__fini()
...
/// Check for srv/SetOdometry message equality.
/**
...
/// Copy a srv/SetOdometry message.
/**
...
/// Initialize array of srv/SetOdometry messages.
/**
...
/// Finalize array of srv/SetOdometry messages.
/**
 * It calls
 * robotnik_controllers_msgs__srv__SetOdometry_Request__fini()
...
/// Create array of srv/SetOdometry messages.
/**
 * It allocates the memory for the array and calls
 * robotnik_controllers_msgs__srv__SetOdometry_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetOdometry messages.
/**
 * It calls
 * robotnik_controllers_msgs__srv__SetOdometry_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetOdometry message array equality.
/**
...
/// Copy an array of srv/SetOdometry messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robotnik_controllers_msgs__srv__SetOdometry_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robotnik_controllers_msgs
...
/**
 * It calls
 * robotnik_controllers_msgs__srv__SetOdometry_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robotnik_controllers_msgs
...
/**
 * It allocates the memory for the array and calls
 * robotnik_controllers_msgs__srv__SetOdometry_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robotnik_controllers_msgs
...
/**
 * It calls
 * robotnik_controllers_msgs__srv__SetOdometry_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOTNIK_CONTROLLERS_MSGS__SRV__DETAIL__SET_ODOMETRY__FUNCTIONS_H_
