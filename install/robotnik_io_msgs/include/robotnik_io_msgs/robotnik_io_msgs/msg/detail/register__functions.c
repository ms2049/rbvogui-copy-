...
robotnik_io_msgs__msg__Register__create()
{
  ...
  robotnik_io_msgs__msg__Register * msg = (robotnik_io_msgs__msg__Register *)allocator.allocate(sizeof(robotnik_io_msgs__msg__Register), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robotnik_io_msgs__msg__Register));
  bool success = robotnik_io_msgs__msg__Register__init(msg);
  if (!success) {
...
robotnik_io_msgs__msg__Register__destroy(robotnik_io_msgs__msg__Register * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    robotnik_io_msgs__msg__Register__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
robotnik_io_msgs__msg__Register__Sequence__init(robotnik_io_msgs__msg__Register__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_io_msgs__msg__Register * data = NULL;

  if (size) {
    data = (robotnik_io_msgs__msg__Register *)allocator.zero_allocate(size, sizeof(robotnik_io_msgs__msg__Register), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robotnik_io_msgs__msg__Register__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        robotnik_io_msgs__msg__Register__fini(&data[i - 1]);
      }
...
robotnik_io_msgs__msg__Register__Sequence__fini(robotnik_io_msgs__msg__Register__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      robotnik_io_msgs__msg__Register__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_io_msgs__msg__Register__Sequence * array = (robotnik_io_msgs__msg__Register__Sequence *)allocator.allocate(sizeof(robotnik_io_msgs__msg__Register__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robotnik_io_msgs__msg__Register__Sequence__init(array, size);
  if (!success) {
...
robotnik_io_msgs__msg__Register__Sequence__destroy(robotnik_io_msgs__msg__Register__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robotnik_io_msgs__msg__Register__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robotnik_io_msgs__msg__Register__Sequence__are_equal(const robotnik_io_msgs__msg__Register__Sequence * lhs, const robotnik_io_msgs__msg__Register__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robotnik_io_msgs__msg__Register__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robotnik_io_msgs__msg__Register__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robotnik_io_msgs__msg__Register);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robotnik_io_msgs__msg__Register * data =
      (robotnik_io_msgs__msg__Register *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robotnik_io_msgs__msg__Register__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robotnik_io_msgs__msg__Register__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!robotnik_io_msgs__msg__Register__copy(
