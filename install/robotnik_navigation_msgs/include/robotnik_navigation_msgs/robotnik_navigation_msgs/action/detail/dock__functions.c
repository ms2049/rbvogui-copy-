...
robotnik_navigation_msgs__action__Dock_Goal__init(robotnik_navigation_msgs__action__Dock_Goal * msg)
{
  ...
  // dock_frame
  if (!rosidl_runtime_c__String__init(&msg->dock_frame)) {
    robotnik_navigation_msgs__action__Dock_Goal__fini(msg);
    return false;
  }
  // robot_dock_frame
  if (!rosidl_runtime_c__String__init(&msg->robot_dock_frame)) {
    robotnik_navigation_msgs__action__Dock_Goal__fini(msg);
    return false;
  }
  // dock_offset
  if (!geometry_msgs__msg__Pose2D__init(&msg->dock_offset)) {
    robotnik_navigation_msgs__action__Dock_Goal__fini(msg);
    return false;
  }
  // maximum_velocity
...
robotnik_navigation_msgs__action__Dock_Goal__fini(robotnik_navigation_msgs__action__Dock_Goal * msg)
{
  ...
  // dock_frame
  rosidl_runtime_c__String__fini(&msg->dock_frame);
  // robot_dock_frame
  rosidl_runtime_c__String__fini(&msg->robot_dock_frame);
  // dock_offset
  geometry_msgs__msg__Pose2D__fini(&msg->dock_offset);
  // maximum_velocity
  ...
  robotnik_navigation_msgs__action__Dock_Goal * output)
{
  ...
  if (!rosidl_runtime_c__String__copy(
      &(input->dock_frame), &(output->dock_frame)))
  {
    return false;
  }
  // robot_dock_frame
  if (!rosidl_runtime_c__String__copy(
      &(input->robot_dock_frame), &(output->robot_dock_frame)))
  {
    return false;
  }
  // dock_offset
  if (!geometry_msgs__msg__Pose2D__copy(
      &(input->dock_offset), &(output->dock_offset)))
  {
    return false;
  }
  // maximum_velocity
...
robotnik_navigation_msgs__action__Dock_Goal__create()
{
  ...
  robotnik_navigation_msgs__action__Dock_Goal * msg = (robotnik_navigation_msgs__action__Dock_Goal *)allocator.allocate(sizeof(robotnik_navigation_msgs__action__Dock_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robotnik_navigation_msgs__action__Dock_Goal));
  bool success = robotnik_navigation_msgs__action__Dock_Goal__init(msg);
  if (!success) {
...
robotnik_navigation_msgs__action__Dock_Goal__Sequence__init(robotnik_navigation_msgs__action__Dock_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_Goal * data = NULL;

  if (size) {
    data = (robotnik_navigation_msgs__action__Dock_Goal *)allocator.zero_allocate(size, sizeof(robotnik_navigation_msgs__action__Dock_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robotnik_navigation_msgs__action__Dock_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        robotnik_navigation_msgs__action__Dock_Goal__fini(&data[i - 1]);
      }
...
robotnik_navigation_msgs__action__Dock_Goal__Sequence__fini(robotnik_navigation_msgs__action__Dock_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      robotnik_navigation_msgs__action__Dock_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_Goal__Sequence * array = (robotnik_navigation_msgs__action__Dock_Goal__Sequence *)allocator.allocate(sizeof(robotnik_navigation_msgs__action__Dock_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robotnik_navigation_msgs__action__Dock_Goal__Sequence__init(array, size);
  if (!success) {
...
robotnik_navigation_msgs__action__Dock_Goal__Sequence__destroy(robotnik_navigation_msgs__action__Dock_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robotnik_navigation_msgs__action__Dock_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robotnik_navigation_msgs__action__Dock_Goal__Sequence__are_equal(const robotnik_navigation_msgs__action__Dock_Goal__Sequence * lhs, const robotnik_navigation_msgs__action__Dock_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robotnik_navigation_msgs__action__Dock_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robotnik_navigation_msgs__action__Dock_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robotnik_navigation_msgs__action__Dock_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robotnik_navigation_msgs__action__Dock_Goal * data =
      (robotnik_navigation_msgs__action__Dock_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robotnik_navigation_msgs__action__Dock_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robotnik_navigation_msgs__action__Dock_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!robotnik_navigation_msgs__action__Dock_Goal__copy(
...
robotnik_navigation_msgs__action__Dock_Result__init(robotnik_navigation_msgs__action__Dock_Result * msg)
{
  ...
  if (!robotnik_common_msgs__msg__Response__init(&msg->response)) {
    robotnik_navigation_msgs__action__Dock_Result__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_Result * msg = (robotnik_navigation_msgs__action__Dock_Result *)allocator.allocate(sizeof(robotnik_navigation_msgs__action__Dock_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robotnik_navigation_msgs__action__Dock_Result));
  bool success = robotnik_navigation_msgs__action__Dock_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
robotnik_navigation_msgs__action__Dock_Result__Sequence__init(robotnik_navigation_msgs__action__Dock_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_Result * data = NULL;

  if (size) {
    data = (robotnik_navigation_msgs__action__Dock_Result *)allocator.zero_allocate(size, sizeof(robotnik_navigation_msgs__action__Dock_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robotnik_navigation_msgs__action__Dock_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robotnik_navigation_msgs__action__Dock_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
robotnik_navigation_msgs__action__Dock_Result__Sequence__fini(robotnik_navigation_msgs__action__Dock_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robotnik_navigation_msgs__action__Dock_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_Result__Sequence * array = (robotnik_navigation_msgs__action__Dock_Result__Sequence *)allocator.allocate(sizeof(robotnik_navigation_msgs__action__Dock_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robotnik_navigation_msgs__action__Dock_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
robotnik_navigation_msgs__action__Dock_Result__Sequence__destroy(robotnik_navigation_msgs__action__Dock_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robotnik_navigation_msgs__action__Dock_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robotnik_navigation_msgs__action__Dock_Result__Sequence__are_equal(const robotnik_navigation_msgs__action__Dock_Result__Sequence * lhs, const robotnik_navigation_msgs__action__Dock_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robotnik_navigation_msgs__action__Dock_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robotnik_navigation_msgs__action__Dock_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robotnik_navigation_msgs__action__Dock_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robotnik_navigation_msgs__action__Dock_Result * data =
      (robotnik_navigation_msgs__action__Dock_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robotnik_navigation_msgs__action__Dock_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robotnik_navigation_msgs__action__Dock_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robotnik_navigation_msgs__action__Dock_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
robotnik_navigation_msgs__action__Dock_Feedback__init(robotnik_navigation_msgs__action__Dock_Feedback * msg)
{
  ...
  if (!geometry_msgs__msg__Pose2D__init(&msg->remaining)) {
    robotnik_navigation_msgs__action__Dock_Feedback__fini(msg);
    return false;
  }
  // current_velocity
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_Feedback * msg = (robotnik_navigation_msgs__action__Dock_Feedback *)allocator.allocate(sizeof(robotnik_navigation_msgs__action__Dock_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robotnik_navigation_msgs__action__Dock_Feedback));
  bool success = robotnik_navigation_msgs__action__Dock_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
robotnik_navigation_msgs__action__Dock_Feedback__Sequence__init(robotnik_navigation_msgs__action__Dock_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_Feedback * data = NULL;

  if (size) {
    data = (robotnik_navigation_msgs__action__Dock_Feedback *)allocator.zero_allocate(size, sizeof(robotnik_navigation_msgs__action__Dock_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robotnik_navigation_msgs__action__Dock_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robotnik_navigation_msgs__action__Dock_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
robotnik_navigation_msgs__action__Dock_Feedback__Sequence__fini(robotnik_navigation_msgs__action__Dock_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robotnik_navigation_msgs__action__Dock_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_Feedback__Sequence * array = (robotnik_navigation_msgs__action__Dock_Feedback__Sequence *)allocator.allocate(sizeof(robotnik_navigation_msgs__action__Dock_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robotnik_navigation_msgs__action__Dock_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
robotnik_navigation_msgs__action__Dock_Feedback__Sequence__destroy(robotnik_navigation_msgs__action__Dock_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robotnik_navigation_msgs__action__Dock_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robotnik_navigation_msgs__action__Dock_Feedback__Sequence__are_equal(const robotnik_navigation_msgs__action__Dock_Feedback__Sequence * lhs, const robotnik_navigation_msgs__action__Dock_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robotnik_navigation_msgs__action__Dock_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robotnik_navigation_msgs__action__Dock_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robotnik_navigation_msgs__action__Dock_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robotnik_navigation_msgs__action__Dock_Feedback * data =
      (robotnik_navigation_msgs__action__Dock_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robotnik_navigation_msgs__action__Dock_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robotnik_navigation_msgs__action__Dock_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robotnik_navigation_msgs__action__Dock_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
robotnik_navigation_msgs__action__Dock_SendGoal_Request__init(robotnik_navigation_msgs__action__Dock_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    robotnik_navigation_msgs__action__Dock_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!robotnik_navigation_msgs__action__Dock_Goal__init(&msg->goal)) {
    robotnik_navigation_msgs__action__Dock_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
robotnik_navigation_msgs__action__Dock_SendGoal_Request__fini(robotnik_navigation_msgs__action__Dock_SendGoal_Request * msg)
{
  ...
  // goal
  robotnik_navigation_msgs__action__Dock_Goal__fini(&msg->goal);
}
...
robotnik_navigation_msgs__action__Dock_SendGoal_Request__are_equal(const robotnik_navigation_msgs__action__Dock_SendGoal_Request * lhs, const robotnik_navigation_msgs__action__Dock_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!robotnik_navigation_msgs__action__Dock_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_SendGoal_Request * msg = (robotnik_navigation_msgs__action__Dock_SendGoal_Request *)allocator.allocate(sizeof(robotnik_navigation_msgs__action__Dock_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robotnik_navigation_msgs__action__Dock_SendGoal_Request));
  bool success = robotnik_navigation_msgs__action__Dock_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
robotnik_navigation_msgs__action__Dock_SendGoal_Request__Sequence__init(robotnik_navigation_msgs__action__Dock_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_SendGoal_Request * data = NULL;

  if (size) {
    data = (robotnik_navigation_msgs__action__Dock_SendGoal_Request *)allocator.zero_allocate(size, sizeof(robotnik_navigation_msgs__action__Dock_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robotnik_navigation_msgs__action__Dock_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robotnik_navigation_msgs__action__Dock_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
robotnik_navigation_msgs__action__Dock_SendGoal_Request__Sequence__fini(robotnik_navigation_msgs__action__Dock_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robotnik_navigation_msgs__action__Dock_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_SendGoal_Request__Sequence * array = (robotnik_navigation_msgs__action__Dock_SendGoal_Request__Sequence *)allocator.allocate(sizeof(robotnik_navigation_msgs__action__Dock_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robotnik_navigation_msgs__action__Dock_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
robotnik_navigation_msgs__action__Dock_SendGoal_Request__Sequence__destroy(robotnik_navigation_msgs__action__Dock_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robotnik_navigation_msgs__action__Dock_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robotnik_navigation_msgs__action__Dock_SendGoal_Request__Sequence__are_equal(const robotnik_navigation_msgs__action__Dock_SendGoal_Request__Sequence * lhs, const robotnik_navigation_msgs__action__Dock_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robotnik_navigation_msgs__action__Dock_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robotnik_navigation_msgs__action__Dock_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robotnik_navigation_msgs__action__Dock_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robotnik_navigation_msgs__action__Dock_SendGoal_Request * data =
      (robotnik_navigation_msgs__action__Dock_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robotnik_navigation_msgs__action__Dock_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robotnik_navigation_msgs__action__Dock_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robotnik_navigation_msgs__action__Dock_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
robotnik_navigation_msgs__action__Dock_SendGoal_Response__init(robotnik_navigation_msgs__action__Dock_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    robotnik_navigation_msgs__action__Dock_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_SendGoal_Response * msg = (robotnik_navigation_msgs__action__Dock_SendGoal_Response *)allocator.allocate(sizeof(robotnik_navigation_msgs__action__Dock_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robotnik_navigation_msgs__action__Dock_SendGoal_Response));
  bool success = robotnik_navigation_msgs__action__Dock_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
robotnik_navigation_msgs__action__Dock_SendGoal_Response__Sequence__init(robotnik_navigation_msgs__action__Dock_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_SendGoal_Response * data = NULL;

  if (size) {
    data = (robotnik_navigation_msgs__action__Dock_SendGoal_Response *)allocator.zero_allocate(size, sizeof(robotnik_navigation_msgs__action__Dock_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robotnik_navigation_msgs__action__Dock_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robotnik_navigation_msgs__action__Dock_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
robotnik_navigation_msgs__action__Dock_SendGoal_Response__Sequence__fini(robotnik_navigation_msgs__action__Dock_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robotnik_navigation_msgs__action__Dock_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_SendGoal_Response__Sequence * array = (robotnik_navigation_msgs__action__Dock_SendGoal_Response__Sequence *)allocator.allocate(sizeof(robotnik_navigation_msgs__action__Dock_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robotnik_navigation_msgs__action__Dock_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
robotnik_navigation_msgs__action__Dock_SendGoal_Response__Sequence__destroy(robotnik_navigation_msgs__action__Dock_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robotnik_navigation_msgs__action__Dock_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robotnik_navigation_msgs__action__Dock_SendGoal_Response__Sequence__are_equal(const robotnik_navigation_msgs__action__Dock_SendGoal_Response__Sequence * lhs, const robotnik_navigation_msgs__action__Dock_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robotnik_navigation_msgs__action__Dock_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robotnik_navigation_msgs__action__Dock_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robotnik_navigation_msgs__action__Dock_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robotnik_navigation_msgs__action__Dock_SendGoal_Response * data =
      (robotnik_navigation_msgs__action__Dock_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robotnik_navigation_msgs__action__Dock_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robotnik_navigation_msgs__action__Dock_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robotnik_navigation_msgs__action__Dock_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
robotnik_navigation_msgs__action__Dock_GetResult_Request__init(robotnik_navigation_msgs__action__Dock_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    robotnik_navigation_msgs__action__Dock_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_GetResult_Request * msg = (robotnik_navigation_msgs__action__Dock_GetResult_Request *)allocator.allocate(sizeof(robotnik_navigation_msgs__action__Dock_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robotnik_navigation_msgs__action__Dock_GetResult_Request));
  bool success = robotnik_navigation_msgs__action__Dock_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
robotnik_navigation_msgs__action__Dock_GetResult_Request__Sequence__init(robotnik_navigation_msgs__action__Dock_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_GetResult_Request * data = NULL;

  if (size) {
    data = (robotnik_navigation_msgs__action__Dock_GetResult_Request *)allocator.zero_allocate(size, sizeof(robotnik_navigation_msgs__action__Dock_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robotnik_navigation_msgs__action__Dock_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robotnik_navigation_msgs__action__Dock_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
robotnik_navigation_msgs__action__Dock_GetResult_Request__Sequence__fini(robotnik_navigation_msgs__action__Dock_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robotnik_navigation_msgs__action__Dock_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_GetResult_Request__Sequence * array = (robotnik_navigation_msgs__action__Dock_GetResult_Request__Sequence *)allocator.allocate(sizeof(robotnik_navigation_msgs__action__Dock_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robotnik_navigation_msgs__action__Dock_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
robotnik_navigation_msgs__action__Dock_GetResult_Request__Sequence__destroy(robotnik_navigation_msgs__action__Dock_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robotnik_navigation_msgs__action__Dock_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robotnik_navigation_msgs__action__Dock_GetResult_Request__Sequence__are_equal(const robotnik_navigation_msgs__action__Dock_GetResult_Request__Sequence * lhs, const robotnik_navigation_msgs__action__Dock_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robotnik_navigation_msgs__action__Dock_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robotnik_navigation_msgs__action__Dock_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robotnik_navigation_msgs__action__Dock_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robotnik_navigation_msgs__action__Dock_GetResult_Request * data =
      (robotnik_navigation_msgs__action__Dock_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robotnik_navigation_msgs__action__Dock_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robotnik_navigation_msgs__action__Dock_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robotnik_navigation_msgs__action__Dock_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
robotnik_navigation_msgs__action__Dock_GetResult_Response__init(robotnik_navigation_msgs__action__Dock_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!robotnik_navigation_msgs__action__Dock_Result__init(&msg->result)) {
    robotnik_navigation_msgs__action__Dock_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
robotnik_navigation_msgs__action__Dock_GetResult_Response__fini(robotnik_navigation_msgs__action__Dock_GetResult_Response * msg)
{
  ...
  // status
  // result
  robotnik_navigation_msgs__action__Dock_Result__fini(&msg->result);
}
...
robotnik_navigation_msgs__action__Dock_GetResult_Response__are_equal(const robotnik_navigation_msgs__action__Dock_GetResult_Response * lhs, const robotnik_navigation_msgs__action__Dock_GetResult_Response * rhs)
{
  ...
  // result
  if (!robotnik_navigation_msgs__action__Dock_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_GetResult_Response * msg = (robotnik_navigation_msgs__action__Dock_GetResult_Response *)allocator.allocate(sizeof(robotnik_navigation_msgs__action__Dock_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robotnik_navigation_msgs__action__Dock_GetResult_Response));
  bool success = robotnik_navigation_msgs__action__Dock_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
robotnik_navigation_msgs__action__Dock_GetResult_Response__Sequence__init(robotnik_navigation_msgs__action__Dock_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_GetResult_Response * data = NULL;

  if (size) {
    data = (robotnik_navigation_msgs__action__Dock_GetResult_Response *)allocator.zero_allocate(size, sizeof(robotnik_navigation_msgs__action__Dock_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robotnik_navigation_msgs__action__Dock_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robotnik_navigation_msgs__action__Dock_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
robotnik_navigation_msgs__action__Dock_GetResult_Response__Sequence__fini(robotnik_navigation_msgs__action__Dock_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robotnik_navigation_msgs__action__Dock_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_GetResult_Response__Sequence * array = (robotnik_navigation_msgs__action__Dock_GetResult_Response__Sequence *)allocator.allocate(sizeof(robotnik_navigation_msgs__action__Dock_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robotnik_navigation_msgs__action__Dock_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
robotnik_navigation_msgs__action__Dock_GetResult_Response__Sequence__destroy(robotnik_navigation_msgs__action__Dock_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robotnik_navigation_msgs__action__Dock_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robotnik_navigation_msgs__action__Dock_GetResult_Response__Sequence__are_equal(const robotnik_navigation_msgs__action__Dock_GetResult_Response__Sequence * lhs, const robotnik_navigation_msgs__action__Dock_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robotnik_navigation_msgs__action__Dock_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robotnik_navigation_msgs__action__Dock_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robotnik_navigation_msgs__action__Dock_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robotnik_navigation_msgs__action__Dock_GetResult_Response * data =
      (robotnik_navigation_msgs__action__Dock_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robotnik_navigation_msgs__action__Dock_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robotnik_navigation_msgs__action__Dock_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robotnik_navigation_msgs__action__Dock_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
robotnik_navigation_msgs__action__Dock_FeedbackMessage__init(robotnik_navigation_msgs__action__Dock_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    robotnik_navigation_msgs__action__Dock_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!robotnik_navigation_msgs__action__Dock_Feedback__init(&msg->feedback)) {
    robotnik_navigation_msgs__action__Dock_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
robotnik_navigation_msgs__action__Dock_FeedbackMessage__fini(robotnik_navigation_msgs__action__Dock_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  robotnik_navigation_msgs__action__Dock_Feedback__fini(&msg->feedback);
}
...
robotnik_navigation_msgs__action__Dock_FeedbackMessage__are_equal(const robotnik_navigation_msgs__action__Dock_FeedbackMessage * lhs, const robotnik_navigation_msgs__action__Dock_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!robotnik_navigation_msgs__action__Dock_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_FeedbackMessage * msg = (robotnik_navigation_msgs__action__Dock_FeedbackMessage *)allocator.allocate(sizeof(robotnik_navigation_msgs__action__Dock_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robotnik_navigation_msgs__action__Dock_FeedbackMessage));
  bool success = robotnik_navigation_msgs__action__Dock_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
robotnik_navigation_msgs__action__Dock_FeedbackMessage__Sequence__init(robotnik_navigation_msgs__action__Dock_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_FeedbackMessage * data = NULL;

  if (size) {
    data = (robotnik_navigation_msgs__action__Dock_FeedbackMessage *)allocator.zero_allocate(size, sizeof(robotnik_navigation_msgs__action__Dock_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robotnik_navigation_msgs__action__Dock_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robotnik_navigation_msgs__action__Dock_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
robotnik_navigation_msgs__action__Dock_FeedbackMessage__Sequence__fini(robotnik_navigation_msgs__action__Dock_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robotnik_navigation_msgs__action__Dock_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_navigation_msgs__action__Dock_FeedbackMessage__Sequence * array = (robotnik_navigation_msgs__action__Dock_FeedbackMessage__Sequence *)allocator.allocate(sizeof(robotnik_navigation_msgs__action__Dock_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robotnik_navigation_msgs__action__Dock_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
robotnik_navigation_msgs__action__Dock_FeedbackMessage__Sequence__destroy(robotnik_navigation_msgs__action__Dock_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robotnik_navigation_msgs__action__Dock_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robotnik_navigation_msgs__action__Dock_FeedbackMessage__Sequence__are_equal(const robotnik_navigation_msgs__action__Dock_FeedbackMessage__Sequence * lhs, const robotnik_navigation_msgs__action__Dock_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robotnik_navigation_msgs__action__Dock_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robotnik_navigation_msgs__action__Dock_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robotnik_navigation_msgs__action__Dock_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robotnik_navigation_msgs__action__Dock_FeedbackMessage * data =
      (robotnik_navigation_msgs__action__Dock_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robotnik_navigation_msgs__action__Dock_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robotnik_navigation_msgs__action__Dock_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robotnik_navigation_msgs__action__Dock_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
