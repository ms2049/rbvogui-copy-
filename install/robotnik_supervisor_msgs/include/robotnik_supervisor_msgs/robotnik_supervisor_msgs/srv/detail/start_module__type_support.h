...
#ifndef ROBOTNIK_SUPERVISOR_MSGS__SRV__DETAIL__START_MODULE__TYPE_SUPPORT_H_
#define ROBOTNIK_SUPERVISOR_MSGS__SRV__DETAIL__START_MODULE__TYPE_SUPPORT_H_
...
#endif  // ROBOTNIK_SUPERVISOR_MSGS__SRV__DETAIL__START_MODULE__TYPE_SUPPORT_H_
